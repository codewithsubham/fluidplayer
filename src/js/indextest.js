...
{	
	...
	{	
		...
		// is hls is being played then no quality will be rendered
...
{	
	...
	return new Promise((resolve , reject) => {
			...
			xmlhttp.open("GET","https://cors-anywhere.herokuapp.com/http://visionitlabs.com/vplayer3/bookmarks/getbookmarks.php?url="+videoURL+"&username="+conf.userName,true);
			xmlhttp.send();
...
function onBookmarkAddClick(val)
{
	...
	xmlhttp.open("GET","https://cors-anywhere.herokuapp.com/http://visionitlabs.com/vplayer3/bookmarks/addbookmark.php?url="+videoURL+"&comment="+document.getElementById("txtAddBookmark").value+"&timestamp="+video.currentTime+"&username="+conf.userName, true);
    xmlhttp.send();
...
function onBookmarkDeleteClick(val)
{
    ...
    xmlhttp.open("GET","https://cors-anywhere.herokuapp.com/http://visionitlabs.com/vplayer3/bookmarks/deletebookmark.php?id="+val+"&username="+conf.userName, true);
    xmlhttp.send();
