...
{	
	...
	return new Promise((resolve , reject) => {
			...
			xmlhttp.open("GET","http://visionitlabs.com/vplayer3/bookmarks/getbookmarks.php?url="+videoURL,true);
			xmlhttp.send();
...
function onBookmarkAddClick()
{
	...
	return new Promise((resolve , reject) => {
		...
		xmlhttp.open("GET","http://visionitlabs.com/vplayer3/bookmarks/addbookmark.php?url="+videoURL+"&comment="+document.getElementById("txtAddBookmark").value+"&timestamp="+video.currentTime, true);
		xmlhttp.send();
...
function onBookmarkDeleteClick(val)
{
    ...
    xmlhttp.open("GET","http://visionitlabs.com/vplayer3/bookmarks/deletebookmark.php?id="+val, true);
    xmlhttp.send();
